...
CREATE TABLE COMPETITION (IDCOMPETITION  VARCHAR(20) PRIMARY KEY     NOT NULL,
				...
				INMOMENTINSCRIPTION BOOLEAN NOT NULL,
				SECUENCIAL BOOLEAN NOT NULL,
                SLOTS INT NOT NULL); 
...
CREATE TABLE INSCRIPTION (DNI  VARCHAR(20)  NOT NULL,
				...
				CATEGORY  VARCHAR(20),
				DORSAL INT,				
                INSCRIPTIONSTATE VARCHAR(20)    NOT NULL check(INSCRIPTIONSTATE in ('INSCRITO','PAGADO','PENDIENTE','PRE-INSCRITO','CANCELADO')), 
                ANOTATIONS VARCHAR(50),
